...
describe FeedbacksController do
  ...
  let(:feedback)  { create :feedback,  release: release, user: user    }
  ...
  describe 'authorization' do
    ...
    context 'as a release owner' do
      ...
      it { should     have_access_to :patch, :update, release_id: release.to_param,       id: feedback.to_param       }
      it { should_not have_access_to :patch, :update, release_id: release.to_param,       id: other_feedback.to_param }
    end
    
    context 'as a recipient' do
      let(:feedback) { create :feedback, release: release, recipient: recipient, user: nil }
